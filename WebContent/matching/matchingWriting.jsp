...
<body>
<form name="f" method="POST" accept-charset="UTF-8" method="GET" action="<c:url value='/matching/write' />">
	<div align="center">
	<h3 >게시글 작성</h3>
	...
	<!-- pattern 속성을 이용한 정규표현식으로 데이터의 유효성 검사를 할 수 있다. -->
    	<input type="text" class="form-control" id="title" placeholder="제목 입력(최대  20글자)" name="title"
