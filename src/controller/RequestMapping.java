...
public class RequestMapping {
    ...
    public void initMapping() {
     ...
     // ticket 
        ...
        mappings.put("/rent", new BikeRentController());
        mappings.put("/rent/rentList", new ForwardController("/rent/rentList.jsp"));
        mappings.put("/rent/list", new BikeListRentController());
        mappings.put("/rent/return", new BikeReturnController());
   
        mappings.put("/rentList", new ForwardController("/rent/rentList.jsp"));
        mappings.put("/rentReturn", new ForwardController("/rent/return.jsp"));
        mappings.put("/rentHistoty", new ForwardController("/rent/returnList.jsp"));
